"""
Программа расчета сцепления для машин выпущенных после 06.2011 года
"""
...
def RingThickness(A12a, A12b, K12sc): # # Расчетная толщина кольца для К1 и К2
    A12 = float((((A12a + A12b) / 2) - A0) * 10)
    K12 = float(A12 - B)
    SK12 = float(K12 + K12sc)
    return SK12
...
SK1 = (RingThickness(A1a, A1b, K1sc)) # Толщина кольца
...
SK2 = (RingThickness(A2a, A2b, K2sc)) # Толщина кольца
...
#
# A1 = (((A1a + A1b) / 2) - A0) * 10
# K1 = A1 - B  # Расчетная толщина кольца
#
...
#
# A2 = (((A2a + A2b) / 2) - A0) * 10
# K2 = A2 - B  # Расчетная толщина кольца
#
